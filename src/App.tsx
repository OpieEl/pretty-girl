...
function App() {
  const steps = [
    {
      content: "Hey, my pretty girl, Chidera (Angela, Shade).",
      image: "/character/one.png",
    },
    {
      content: `One day, we met.
      And somehow, you've been on my mind ever since.
      `,
      image: "/character/two.png",
    },
    {
      content: `Then we went on our first stroll …And I said fuck it, I want this girl.
      `,
...
hold your hands, and look into your pretty eyes.`,
    ...
    {
      content: "Will you be my Valentine, Princess ?",
